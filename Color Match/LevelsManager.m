...
+(BoardCells*)LoadBoardCellTypes:(int)worldId levelId:(int)levelId boardParameters:(BoardParameters)boardParameters
{
    ...
    else
    {
        ...
        else if (worldId == 7 && levelId == 6)
        {
            ...
            [boardCells setConverterInitialDirectionAt:1 col:3 isDirectionRight:1];
        }
        else if (worldId == 7 && levelId == 7)
        {
            ...
            [boardCells setConverterInitialDirectionAt:1 col:2 isDirectionRight:1];
            [boardCells setConverterDirectionAt:2 col:0 isDirectionRight:1];
            [boardCells setConverterInitialDirectionAt:2 col:0 isDirectionRight:1];
        }
        ...
        else if (worldId == 7 && levelId == 12)
        {
            ...
            [boardCells setConverterDirectionAt:0 col:3 isDirectionRight:0];
            [boardCells setConverterInitialDirectionAt:0 col:3 isDirectionRight:1];
            [boardCells setConverterDirectionAt:1 col:1 isDirectionRight:0];
            [boardCells setConverterInitialDirectionAt:1 col:1 isDirectionRight:0];
            [boardCells setConverterDirectionAt:2 col:0 isDirectionRight:1];
            [boardCells setConverterInitialDirectionAt:2 col:0 isDirectionRight:0];
            [boardCells setConverterDirectionAt:3 col:2 isDirectionRight:1];
            [boardCells setConverterInitialDirectionAt:3 col:2 isDirectionRight:0];
        }
        ...
        else if (worldId == 9 && levelId == 10)
        {
            ...
            [boardCells addShifterValueAt:2 col:0 value:2];
            boardCells.shiftCount = 2;
            [boardCells addZonerValueAt:3 col:3 value:2];
        }
        ...
        else if (worldId == 9 && levelId == 12)
        {
            ...
            [boardCells addShifterValueAt:1 col:4 value:3];
            [boardCells addShifterValueAt:2 col:1 value:2];
            [boardCells addShifterValueAt:3 col:2 value:1];
            boardCells.shiftCount = 1;
...
+(void)GetBoardStatesForLevel:(int)worldId levelId:(int)levelId topColorsState:(NSMutableArray*)topColorsState leftColorsState:(NSMutableArray*)leftColorsState
{
    ...
    else if (worldId == 7 && levelId == 6)
    {
        ...
        [leftColorsState addObjectsFromArray:[NSArray arrayWithObjects:@"0", @"2", @"3", @"1", nil]];
    }
    else if (worldId == 7 && levelId == 7)
    {
        [topColorsState addObjectsFromArray:[NSArray arrayWithObjects:@"3", @"2", @"3", @"2", nil]];
        [leftColorsState addObjectsFromArray:[NSArray arrayWithObjects:@"1", @"2", @"1", @"3", nil]];
    }
    else if (worldId == 7 && levelId == 8)
    {
    ...
    {
        [topColorsState addObjectsFromArray:[NSArray arrayWithObjects:@"2", @"3", @"1", @"3", @"2", nil]];
        [leftColorsState addObjectsFromArray:[NSArray arrayWithObjects:@"1", @"3", @"2", @"1", @"3", nil]];
    }
    else if (worldId == 9 && levelId == 10)
    {
        [topColorsState addObjectsFromArray:[NSArray arrayWithObjects:@"1", @"1", @"3", @"1", @"3", nil]];
        [leftColorsState addObjectsFromArray:[NSArray arrayWithObjects:@"3", @"2", @"1", @"3", @"1", nil]];
    }
    else if (worldId == 9 && levelId == 11)
    {
    ...
    {
        [topColorsState addObjectsFromArray:[NSArray arrayWithObjects:@"1", @"1", @"3", @"2", @"1", nil]];
        [leftColorsState addObjectsFromArray:[NSArray arrayWithObjects:@"2", @"2", @"3", @"3", @"2", nil]];
    }
    else if (worldId == 9 && levelId == 13)
    {
        [topColorsState addObjectsFromArray:[NSArray arrayWithObjects:@"1", @"2", @"3", @"2", @"1", nil]];
